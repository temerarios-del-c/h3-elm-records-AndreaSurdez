...
--ejercicio 2
type alias SoP = {name : String, uType : String}
...
onlyStudents list =
    List.map (\n -> if n.uType =="Professor" then "" else if n.uType == "Student" then n.name else "ERROR") list
...
persona2 = {persona | ciudad = "Barcelona"}
...
type alias Producto = {nombre : String, precio : Int, enStock : Bool}
...
type alias Persona = { nombre : String, edad : Int }
